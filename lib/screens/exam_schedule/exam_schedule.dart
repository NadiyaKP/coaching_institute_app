...
class _ExamScheduleScreenState extends State<ExamScheduleScreen> {
  ...
  // Add these timer-related variables
...
String _formatCountdown(Duration duration) {
  ...
  void _sortAndCategorizeExams() {
    // Sort exams: active first, then upcoming, then past
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                icon: Icon(isOnlineStudent ? Icons.analytics_rounded : Icons.calendar_today_rounded, size: 20),
                label: isOnlineStudent ? 'Performance' : 'Exam Schedule',
              ),
              const BottomNavigationBarItem(
