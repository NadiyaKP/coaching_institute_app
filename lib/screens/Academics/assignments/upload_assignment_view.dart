...
class UploadAssignmentView extends StatefulWidget {
  ...
  @override
  State<UploadAssignmentView> createState() => _UploadAssignmentViewState();
}

class _UploadAssignmentViewState extends State<UploadAssignmentView> {
